...
This guide walks through testing the entire Web Search Skill integration with GucciAI.

## Prerequisites

1. GucciAI built and ready to run
2. Google Chrome installed
3. Internet connection available

## Test 1: Service Auto-Start

**Objective:** Verify that the Bridge Server starts automatically with GucciAI.

**Steps:**

1. Start GucciAI in development mode:
   ```bash
...
**Expected Result:** ✅ Bridge Server starts automatically within 3 seconds of GucciAI launch.
...
1. Open a terminal while GucciAI is running
...
**Objective:** Verify graceful shutdown of services when GucciAI quits.

**Steps:**

1. With GucciAI running and searches completed, quit the application
...
1. Start GucciAI (ensure headless is false in config)
...
- ✅ Server auto-starts with GucciAI
