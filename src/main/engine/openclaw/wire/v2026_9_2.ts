...
export type OpenClawSessionRowV2026_9_2 = {
  key: string;
...
export type OpenClawSessionsListResultV2026_9_2 = {
  sessions: OpenClawSessionRowV2026_9_2[];
  nextOffset?: number | null;
  hasMore?: boolean;
};

export const parseSessionsListResultV2026_9_2 = (
  value: unknown,
): OpenClawSessionsListResultV2026_9_2 => {
...
export type OpenClawChatHistoryResultV2026_9_2 = {
  messages: unknown[];
  hasMore: boolean;
  nextOffset?: number;
...
export const parseChatHistoryResultV2026_9_2 = (
  value: unknown,
): OpenClawChatHistoryResultV2026_9_2 => {
...
export const parseHistoryDetailsResultV2026_9_2 = (
  value: unknown,
  ...
  const compactionDetails: OpenClawHistoryDetailsResultV2026_9_2['compactionDetails'] = {};
...
export const OPENCLAW_TASK_STATUSES_V2026_9_2 = [
  'queued',
  'running',
  'completed',
  'failed',
...
export const parseTaskSummaryV2026_9_2 = (
  value: unknown,
  field = 'task',
  ...
  if (
    ...
    !OPENCLAW_TASK_STATUSES_V2026_9_2.includes(value.status as OpenClawTaskStatusV2026_9_2)
  ) {
...
export const parseTasksListResultV2026_9_2 = (
  value: unknown,
): { tasks: OpenClawTaskSummaryV2026_9_2[]; nextCursor?: string } => {
  ...
  return {
    tasks: value.tasks.map((task, index) =>
      parseTaskSummaryV2026_9_2(task, `tasks.list tasks[${index}]`),
    ),
    ...(nextCursor ? { nextCursor } : {}),
  };
};

export const parseTasksGetResultV2026_9_2 = (
  value: unknown,
): { task: OpenClawTaskSummaryV2026_9_2 } => {
  if (!isRecord(value)) {
    throw new Error(`${OPENCLAW_WIRE_VERSION} tasks.get returned an invalid payload`);
  }
  return { task: parseTaskSummaryV2026_9_2(value.task, 'tasks.get task') };
};

export type OpenClawTaskEventV2026_9_2 =
  | { action: 'upserted'; task: OpenClawTaskSummaryV2026_9_2 }
  | { action: 'deleted'; taskId: string }
  | { action: 'restored' };

export const parseTaskEventV2026_9_2 = (value: unknown): OpenClawTaskEventV2026_9_2 => {
  if (!isRecord(value) || typeof value.action !== 'string') {
    throw new Error(`${OPENCLAW_WIRE_VERSION} task event returned an invalid payload`);
  }
  if (value.action === 'upserted') {
    return { action: 'upserted', task: parseTaskSummaryV2026_9_2(value.task, 'task event task') };
  }
