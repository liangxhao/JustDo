...
const FilePreviewDrawer: React.FC<FilePreviewDrawerProps> = ({ preview, onClose }) => {
  ...
  const handleMarkdownClick = useCallback((event: React.MouseEvent<HTMLElement>) => {
