...
import { selectPrompt } from '@/features/quick-actions/quickActionSlice';
import type { LocalizedPrompt,LocalizedQuickAction } from '@/features/quick-actions/quickActionTypes';
