...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    saving: '保存中...',
    delete: '删除',
    coworkDeleteFromMessage: '删除此条及以下消息',
    create: '创建',
    clear: '清除',
    show: '显示',
    hide: '隐藏',
    ...
    coworkContextUsageLabel: '上下文',
    coworkContextUsageFullLabel: '已使用上下文/总上下文',
    coworkContextUsageRefreshing: '上下文用量更新中',
    coworkWelcome: '开始协作',
    ...
    slashCommandMenu: 'Slash commands',
    slashCommandArguments: 'Command arguments',
    slashCommandCategorySession: 'Session',
    slashCommandCategoryModel: 'Model',
    slashCommandCategoryAgents: 'Agents',
    slashCommandCategoryTools: 'Tools',
    slashCommandFooterSelect: '↑↓ navigate  Tab fill  Enter select  Esc close',
    slashCommandFooterRun: '↑↓ navigate  Tab fill  Enter run  Esc close',
    slashCommandShowMore: 'Show {count} more commands',
    slashCommandOptionsCount: '{count} options',
    slashCommandInstant: 'instant',
    slashCommandHelpDescription: 'Show available commands',
    slashCommandNewDescription: 'Start a new session',
    slashCommandResetDescription: 'Reset the current session',
    slashCommandStopDescription: 'Stop the current task',
    slashCommandClearDescription: 'Clear chat history',
    slashCommandCompactDescription: 'Compact the current context',
    slashCommandModelDescription: 'View or switch models',
    slashCommandThinkDescription: 'Set the thinking level',
    slashCommandFastDescription: 'Toggle fast mode',
    slashCommandVerboseDescription: 'Set verbose output level',
    slashCommandExportSessionDescription: 'Export the current session',
    slashCommandUsageDescription: 'Show usage information',
    slashCommandAgentsDescription: 'Show available agents',
    slashCommandSteerDescription: 'Inject a message into the active task',
    slashCommandRedirectDescription: 'Abort and restart with a new message',
    ...
    cronNewTask: '新建任务',
    cronRefresh: '刷新',
    cronGatewayWarning: '网关未运行。没有活跃的网关，无法管理定时任务。',
    cronStatsTotal: '任务总数',
    cronStatsActive: '运行中',
    cronStatsPaused: '已暂停',
    cronStatsFailed: '失败',
    ...
    cronCardRunNow: '立即运行',
    cronCardDeleteConfirm: '确定要删除此任务吗？',
    cronCardLast: '上次运行',
    cronCardNext: '下次运行',
    cronCardEdit: '编辑',
    ...
    cronDialogDescription: '安排自动化的 AI 任务',
    ...
    cronDialogUsePresets: '使用预设',
    cronDialogUseCustomCron: '使用自定义 Cron',
    ...
    cronDialogDeliveryChannel: '通道',
    cronDialogSelectChannel: '选择通道',
    cronDialogNoChannels: '无可用通道',
  ...
  en: {
    ...
    saving: 'Saving...',
    delete: 'Delete',
    coworkDeleteFromMessage: 'Delete this and following messages',
    create: 'Create',
    clear: 'Clear',
    show: 'Show',
    hide: 'Hide',
    ...
    subTaskDone: 'Done',
    coworkPinSession: 'Pin conversation',
    coworkUnpinSession: 'Unpin conversation',
    ...
    coworkContextUsageLabel: 'Context',
    coworkContextUsageFullLabel: 'Context used / total context',
    coworkContextUsageRefreshing: 'Context usage is updating',
    ...
    cronCardDeleteConfirm: 'Are you sure you want to delete this task?',
    cronCardLast: 'Last',
    cronCardNext: 'Next',
    cronCardEdit: 'Edit',
    ...
    cronDialogDescription: 'Schedule an automated AI task',
    ...
    cronDialogUsePresets: 'Use presets',
    cronDialogUseCustomCron: 'Use custom cron',
    ...
    cronDialogDeliveryChannel: 'Channel',
    cronDialogSelectChannel: 'Select a channel',
    cronDialogNoChannels: 'No channels available',
