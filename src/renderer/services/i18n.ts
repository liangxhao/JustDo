...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    cronEmptyDescription: '创建定时任务以自动化 AI 工作流。任务可以在指定时间发送消息、运行查询或执行操作。',
  ...
  en: {
    ...
    cronRefresh: 'Refresh',
    cronGatewayWarning: 'Gateway is not running. Scheduled tasks cannot be managed without an active Gateway.',
    ...
    cronEmptyDescription: 'Create scheduled tasks to automate AI workflows. Tasks can send messages, run queries, or perform actions at specified times.',
    ...
    cronDialogMessagePlaceholder: "What should the AI do? e.g., Give me a summary of today's news and weather",
    ...
    cronDialogDeliveryDescription: 'Choose whether this task stays in-app or is pushed to an external channel.',
