...
export const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    toolIntegrationTab: '外部连接',
    toolIntegrationDirectionLabel: '工具集成方向',
    toolIntegrationOutboundTab: '连接外部工具',
    toolIntegrationOutboundTabDescription: `由 ${PRODUCT_NAME} 发起连接并调用其他 Agent 工具`,
    toolIntegrationInboundTab: '被外部工具连接',
    toolIntegrationInboundTabDescription: `让其他工具将 ${PRODUCT_NAME} 作为本地 Agent 运行时`,
    toolIntegrationComingSoon: 'Coming Soon',
    toolIntegrationClaudeCode: 'Claude Code',
    toolIntegrationCodex: 'Codex',
    toolIntegrationOutboundTitle: '连接 Claude Code、Codex 等外部工具',
    toolIntegrationOutboundDescription: `未来可从 ${PRODUCT_NAME} 中连接和调用已安装的外部 Agent 工具，并统一管理它们的状态与权限。该能力正在开发中。`,
    toolIntegrationInboundTitle: `允许外部工具调用 ${PRODUCT_NAME}`,
    toolIntegrationInboundDescription: `外部工具可以通过受控的兼容协议调用 ${PRODUCT_NAME} 内置运行时。连接状态、权限和外部会话仍由 ${PRODUCT_NAME} 管理。`,
    ...
    multicaIntegrationDescription: `让 Multica 通过纯本地连接调用 ${PRODUCT_NAME} 内置 Agent 运行时。${PRODUCT_NAME} 必须保持运行或停留在托盘。`,
    multicaEnable: '启用 Multica 集成',
    multicaLauncherPath: 'Launcher 路径',
    multicaCopyPath: '复制路径',
    multicaCopyValue: '复制此值',
    multicaBridgeStatus: '桥接器',
    multicaBundledRuntimeVersion: '内置运行时 {version}',
    multicaGatewayStatus: 'Gateway',
    multicaDaemonStatus: 'Multica daemon',
    multicaRegistrationStatus: '本地 Launcher',
    multicaActiveTasks: '活动任务',
    multicaRegisteredAsProduct: `${PRODUCT_NAME}-agent 已就绪`,
    multicaNotRegistered: '尚未准备',
    multicaManualSetupTitle: '在 Multica 中完成手动配置',
    multicaManualSetupDescription:
      '为了避免本软件访问 Multica 服务器，请打开 Multica 的“新建自定义运行时”，并填写以下内容。若已创建过运行时，也请把“命令”更新为下方完整值。',
    multicaManualProtocolFamily: '基础协议类型',
    multicaManualDisplayName: '显示名称',
    multicaManualCommandName: '命令',
    multicaManualDescription: '描述',
    multicaRecheck: '重新检测',
    multicaPackagedOnly:
      '找不到 Multica 原生 Agent 可执行文件。开发环境请先运行 npm run multica:dev-agent。',
    multicaDaemon_running: '运行中',
    multicaDaemon_stopped: '已停止',
    multicaDaemon_unavailable: '未找到',
    multicaDaemon_unknown: '未知',
    multicaBridge_running: '运行中',
    multicaBridge_stopped: '已停止',
    multicaBridge_error: '错误',
    ...
    coworkQuestionWaitModelDecides: '超时后模型将根据上下文自行判断。',
    ...
    subagentInfoSessionId: 'Session ID',
  ...
  en: {
    ...
    toolIntegrationTab: 'External connections',
    toolIntegrationDirectionLabel: 'Tool integration direction',
    toolIntegrationOutboundTab: 'Connect external tools',
    toolIntegrationOutboundTabDescription: `Let ${PRODUCT_NAME} connect to and invoke other Agent tools`,
    toolIntegrationInboundTab: 'Accept external connections',
    toolIntegrationInboundTabDescription: `Let other tools use ${PRODUCT_NAME} as a local Agent runtime`,
    toolIntegrationComingSoon: 'Coming Soon',
    toolIntegrationClaudeCode: 'Claude Code',
    toolIntegrationCodex: 'Codex',
    toolIntegrationOutboundTitle: 'Connect Claude Code, Codex, and other tools',
    toolIntegrationOutboundDescription: `A future release will let ${PRODUCT_NAME} connect to installed external Agent tools and manage their status and permissions in one place. This capability is currently in development.`,
    toolIntegrationInboundTitle: `Allow external tools to invoke ${PRODUCT_NAME}`,
    toolIntegrationInboundDescription: `External tools can call the runtime bundled with ${PRODUCT_NAME} through a controlled compatibility protocol. ${PRODUCT_NAME} continues to manage connection status, permissions, and external sessions.`,
    ...
    multicaSessionBadge: 'Multica',
    multicaIntegrationDescription: `Let Multica call the Agent runtime bundled with ${PRODUCT_NAME} over a local-only connection. ${PRODUCT_NAME} must remain open or in the tray.`,
    multicaEnable: 'Enable Multica integration',
    multicaLauncherPath: 'Launcher path',
    multicaCopyPath: 'Copy path',
    multicaCopyValue: 'Copy value',
    multicaBridgeStatus: 'Bridge',
    multicaBundledRuntimeVersion: 'Bundled runtime {version}',
    multicaGatewayStatus: 'Gateway',
    multicaDaemonStatus: 'Multica daemon',
    multicaRegistrationStatus: 'Local launcher',
    multicaActiveTasks: 'Active tasks',
    multicaRegisteredAsProduct: `${PRODUCT_NAME}-agent is ready`,
    multicaNotRegistered: 'Not prepared',
    multicaManualSetupTitle: 'Finish setup in Multica',
    multicaManualSetupDescription:
      'To keep this app from accessing the Multica server, open “Create custom runtime” in Multica and enter these values. If a runtime already exists, update its Command to the full value below.',
    multicaManualProtocolFamily: 'Base protocol',
    multicaManualDisplayName: 'Display name',
    multicaManualCommandName: 'Command',
    multicaManualDescription: 'Description',
    multicaRecheck: 'Recheck',
    multicaPackagedOnly:
      'The native Multica Agent executable was not found. In development, run npm run multica:dev-agent first.',
    multicaDaemon_running: 'Running',
    multicaDaemon_stopped: 'Stopped',
    multicaDaemon_unavailable: 'Not found',
    multicaDaemon_unknown: 'Unknown',
    multicaBridge_running: 'Running',
    multicaBridge_stopped: 'Stopped',
    multicaBridge_error: 'Error',
    multicaSessionReadOnly:
      'This session is managed by Multica and is read-only here. Continue or stop the task in Multica.',
    ...
    coworkQuestionWaitModelDecides: 'Lets the model decide from context after timeout.',
