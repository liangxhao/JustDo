...
export const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    model: '模型',
    agentRuntimeTab: '配置',
    agentRuntimeLoading: '正在加载 Agent 运行设置',
    ...
    agentRuntimeSaveFailed: 'Agent 运行设置保存失败。',
    browserSettings: '浏览器',
  ...
  en: {
    ...
    agentRuntimeLoading: 'Loading Agent runtime settings',
    ...
    agentRuntimeSaveFailed: 'Agent runtime settings could not be saved.',
