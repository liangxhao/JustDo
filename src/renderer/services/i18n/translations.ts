...
export const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkQuestionWaitDefaults: '最多等待 {minutes} 分钟；超时后将自动选择标记的默认项。',
    coworkQuestionWaitModelDecides: '最多等待 {minutes} 分钟；超时后模型将根据上下文自行判断。',
    coworkQuestionTimeoutDeadline: '预计于 {deadline} 超时。',
  ...
  en: {
    ...
    coworkQuestionWaitDefaults: 'Waits up to {minutes} minutes, then selects the marked defaults.',
    coworkQuestionWaitModelDecides:
      'Waits up to {minutes} minutes, then lets the model decide from context.',
    coworkQuestionTimeoutDeadline: 'Expected to time out at {deadline}.',
