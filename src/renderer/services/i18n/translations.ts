...
export const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    selectExtensionSourceDescription:
      '暂仅支持包含 openclaw.plugin.json 的原生扩展；缺失依赖将使用当前运行环境安装。',
    ...
    scheduledTasksResultsDeleteConfirm:
      '确定删除“{name}”的这条执行结果吗？关联的 OpenClaw 运行记录和会话也会永久删除。',
    ...
    scheduledTasksResultsBatchDeleteConfirm:
      '确定删除选中的 {count} 条执行结果吗？关联的 OpenClaw 运行记录和会话也会永久删除。',
  ...
  en: {
    ...
    selectExtensionSourceDescription:
      'Only native extensions containing openclaw.plugin.json are currently supported. Missing dependencies are installed using the current runtime environment.',
    ...
    scheduledTasksResultsDeleteConfirm:
      'Delete this result from “{name}”? Its OpenClaw run record and session will also be permanently deleted.',
    ...
    scheduledTasksResultsBatchDeleteConfirm:
      'Delete the selected {count} execution results? Their OpenClaw run records and sessions will also be permanently deleted.',
