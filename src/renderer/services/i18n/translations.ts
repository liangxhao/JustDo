...
export const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    skillMarketplaceComingSoonDescription: '技能市场正在建设中，后续将支持从 ClawHub 在线安装技能。',
    skillMarketplaceSearchPlaceholder: '搜索 ClawHub 技能',
    skillMarketplaceLoading: '正在加载 ClawHub 技能...',
  ...
  en: {
    ...
    skillMarketplaceComingSoonDescription:
      'The skill marketplace is under development. ClawHub installation support is coming soon.',
    skillMarketplaceSearchPlaceholder: 'Search ClawHub skills',
    skillMarketplaceLoading: 'Loading skills from ClawHub...',
