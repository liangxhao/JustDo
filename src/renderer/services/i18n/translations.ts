...
export const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    sessionTotalTokensButtonTitle: '统计主会话与所有 Subagent 的 Token 总量',
    sessionTotalTokensTitle: '总体 Token 用量',
    sessionTotalTokensDescription: '主会话与所有 Subagent 的 Token 用量总和',
  ...
  en: {
    ...
    sessionTotalTokensButtonTitle: 'Total token usage for the main session and all subagents',
    sessionTotalTokensTitle: 'Overall token usage',
    sessionTotalTokensDescription: 'Combined token usage for the main session and all subagents',
