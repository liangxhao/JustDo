...
export const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkToolTimelineNameSeparator: '、',
    ...
    importExtensionTooltip: '从本地文件夹或压缩文件导入 OpenClaw 扩展',
    selectExtensionSourceDescription:
      '暂仅支持包含 openclaw.plugin.json 的 OpenClaw 原生扩展；缺失依赖将使用当前运行环境安装。',
    selectExtensionFolders: '选择文件夹',
    selectExtensionFoldersDescription: '每个文件夹对应一个 OpenClaw 扩展目录',
    selectExtensionArchives: '选择压缩文件',
    selectExtensionArchivesDescription: '可一次选择多个扩展压缩文件；支持 ZIP、TAR、TAR.GZ 和 TGZ',
    extensionArchiveFiles: 'OpenClaw 扩展压缩文件',
    ...
    extensionImportStagePreparingRuntime: '正在准备 OpenClaw 运行环境',
    extensionImportStageInstalling: '正在安装扩展',
    extensionImportStageInstallingDependencies: '正在安装扩展依赖',
    extensionImportStageRestartingGateway: '正在重启 OpenClaw Gateway',
    ...
    extensionDeleteConfirm: '确定删除扩展“{name}”吗？扩展文件和 OpenClaw 配置项将一并移除。',
  ...
  en: {
    ...
    importExtensionTooltip: 'Import an OpenClaw extension from a local folder or archive',
    selectExtensionSourceDescription:
      'Only native OpenClaw extensions containing openclaw.plugin.json are currently supported. Missing dependencies are installed using the current runtime environment.',
    selectExtensionFolders: 'Select folders',
    selectExtensionFoldersDescription: 'Each folder is imported as one OpenClaw extension',
    ...
    extensionArchiveFiles: 'OpenClaw extension archives',
    ...
    extensionImportStagePreparingRuntime: 'Preparing OpenClaw runtime',
    ...
    extensionImportStageRestartingGateway: 'Restarting OpenClaw Gateway',
    ...
    extensionDeleteConfirm:
      'Delete extension “{name}”? Its files and OpenClaw configuration entry will also be removed.',
