...
export const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    modelUnavailableMissingAuth: '缺少认证信息',
    modelUnavailableAuthFailed: '认证失败',
    modelUnavailableCooldown: '暂时冷却中',
    modelUnavailableCooldownUntil: '冷却至 {time}',
    selectedModelUnavailableHint: '当前模型不可用，请选择其他模型',
  ...
  en: {
    ...
    modelNoTools: 'No tools',
    modelUnavailable: 'Currently unavailable',
    modelUnavailableMissingAuth: 'Authentication required',
    modelUnavailableAuthFailed: 'Authentication failed',
    modelUnavailableCooldown: 'Temporarily cooling down',
    modelUnavailableCooldownUntil: 'Cooling down until {time}',
    selectedModelUnavailableHint: 'The current model is unavailable. Select another model',
