...
export const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkGoalPhaseStarting: '正在准备目标执行环境',
    coworkGoalPhaseThinking: '正在分析并规划下一步',
    coworkGoalPhaseTool: '正在执行工具操作',
    coworkGoalPhaseToolNamed: '正在使用工具：{tool}',
    coworkGoalPhaseResponding: '正在整理本轮结果',
    coworkGoalToolCount: '{count} 次操作',
  ...
  en: {
    ...
    coworkGoalPhaseStarting: 'Preparing the goal run',
    coworkGoalPhaseThinking: 'Analyzing and planning the next step',
    coworkGoalPhaseTool: 'Running a tool operation',
    coworkGoalPhaseToolNamed: 'Using tool: {tool}',
    coworkGoalPhaseResponding: 'Summarizing this run',
    coworkGoalToolCount: '{count} operations',
