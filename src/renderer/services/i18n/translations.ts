...
export const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkWaitingPreparing: '正在准备模型请求，请稍等…',
    coworkWaitingModel: '正在等待模型返回内容，请稍等…',
    coworkWaitingTool: '正在等待工具执行完成，请稍等…',
    coworkWaitingSlowActive: '模型响应较慢，任务仍在运行，请耐心等待…',
    coworkWaitingLong: '模型已较长时间没有返回新内容，可以继续等待或停止任务。',
    ...
    coworkWaitingProbeFailed: '暂时无法确认任务状态，正在继续等待…',
  ...
  en: {
    ...
    coworkWaitingPreparing: 'Preparing the model request. Please wait…',
    coworkWaitingModel: 'Waiting for the model to return content. Please wait…',
    coworkWaitingTool: 'Waiting for the tool to finish. Please wait…',
    coworkWaitingSlowActive: 'The model is responding slowly, but the task is still running…',
    coworkWaitingLong: 'The model has not returned new content for a while. You can keep waiting or stop the task.',
    ...
    coworkWaitingReconnecting: 'The runtime connection was interrupted. Reconnecting without losing visible content…',
    coworkWaitingProbeFailed: 'The task status could not be confirmed yet. Still waiting…',
    coworkThinkingLabel: 'Thinking',
    coworkAssistantLabel: 'Assistant',
    coworkSystemMessageLabel: 'System message',
    coworkYouLabel: 'You',
