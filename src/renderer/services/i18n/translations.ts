...
export const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    providerNameExists: '供应商名称已存在，请使用不同的名称',
    providerNameConflictsBuiltin: '不能使用内置模型的供应商名称',
    providerNameInvalid: '供应商名称格式不正确',
  ...
  en: {
    ...
    providerNameConflictsBuiltin: 'Cannot use the built-in model provider name',
    providerNameInvalid: 'Invalid provider name',
