...
export const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    appUpdateTitle: '软件更新',
    appUpdateDescription: '每次打开帮助页时会自动检查最新版本',
    appUpdateCheck: '检查更新',
    ...
    appUpdateToastDescription: '更新已在后台下载，可在方便时重启安装',
  ...
  en: {
    ...
    appUpdateDescription: 'Automatically checks for the latest version whenever Help is opened',
    ...
    appUpdateToastDescription:
      'The update was downloaded in the background and can be installed when convenient',
