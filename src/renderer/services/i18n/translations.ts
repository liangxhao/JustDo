...
export const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    model: '模型',
    browserSettings: '浏览器',
    externalAgentsSettings: '外部 Agent',
    externalAgentsTitle: '外部 Agent 工具',
    externalAgentsDescription:
      '主 Agent 可以通过 ACP 将编码任务委派给已安装的 Claude Code、Codex 或 OpenCode。',
    externalAgentsInspecting: '正在检查本地运行组件…',
    externalAgentsBackendReady: 'ACP 委派组件已就绪。连接状态仅在你主动检测后更新。',
    externalAgentsBackendUnavailable: 'ACP 委派组件不可用，请重新安装或更新应用后再试。',
    externalAgentsLoadFailed: '无法读取外部 Agent 状态',
    externalAgentClaudeName: 'Claude Code',
    externalAgentClaudeDescription: '通过 ACP 调用 Claude Code，适合分析、编码和代码审查任务。',
    externalAgentCodexName: 'Codex',
    externalAgentCodexDescription: '通过 ACP 调用 Codex，适合在本地项目中实施和验证代码变更。',
    externalAgentOpenCodeName: 'OpenCode',
    externalAgentOpenCodeDescription:
      '通过 ACP 调用 OpenCode；首次检测时可能需要下载对应的适配器。',
    externalAgentNotTested: '未检测',
    externalAgentConnected: '连接正常',
    externalAgentFailed: '连接失败',
    externalAgentUnavailable: '不可用',
    externalAgentTest: '检测连接',
    externalAgentTestAll: '检测全部',
    externalAgentTesting: '检测中…',
    externalAgentBackendMissing: '本地缺少 ACP 委派组件。',
    externalAgentAdapterMissing: '本地缺少该 Agent 的 ACP 适配器。',
    externalAgentAuthenticationRequired: '尚未完成登录或凭据无效，请先在对应工具中完成认证。',
    externalAgentTimeout: '连接检测超时，请检查网络和对应工具的登录状态。',
    externalAgentConnectionFailed: '无法建立 ACP 会话，请查看诊断信息并确认对应工具可用。',
    externalAgentLastTested: '最近检测：',
    externalAgentTestNotice:
      '连接检测仅在点击后运行：它只建立 ACP 会话并立即关闭，不发送模型请求，也不会使用工具。',
    externalAgentPermissionNotice:
      '实际委派会遵循当前会话权限：完全访问可写入文件，询问和自动模式仅允许只读操作。',
    ...
    deleteSession: '删除对话',
    subagents: '委派任务',
    subagentEmpty: '当前会话暂无委派任务',
    subagentShowInfo: '查看详情',
    subagentInfoStatus: '状态',
    subagentInfoAgentRuntime: '执行方式',
    subagentRuntimeNative: '内置 Agent',
    subagentRuntimeAcp: '外部 Agent（ACP）',
    subagentRuntimeAcpShort: 'ACP',
    ...
    subagentDrawerTitle: '委派任务：{title}',
    subagentDrawerResize: '调整委派任务面板宽度',
    subagentMessagesEmpty: '暂无委派任务消息',
    subagentMessagesLoadFailed: '加载委派任务消息失败',
  ...
  en: {
    ...
    externalAgentsSettings: 'External agents',
    externalAgentsTitle: 'External agent tools',
    externalAgentsDescription:
      'The primary agent can delegate coding tasks through ACP to Claude Code, Codex, or OpenCode when available.',
    externalAgentsInspecting: 'Inspecting local runtime components…',
    externalAgentsBackendReady:
      'The ACP delegation runtime is ready. Connection status updates only after you run a test.',
    externalAgentsBackendUnavailable:
      'The ACP delegation runtime is unavailable. Reinstall or update the app, then try again.',
    externalAgentsLoadFailed: 'Unable to read external agent status',
    externalAgentClaudeName: 'Claude Code',
    externalAgentClaudeDescription:
      'Runs Claude Code through ACP for analysis, implementation, and code review tasks.',
    externalAgentCodexName: 'Codex',
    externalAgentCodexDescription:
      'Runs Codex through ACP to implement and verify changes in local projects.',
    externalAgentOpenCodeName: 'OpenCode',
    externalAgentOpenCodeDescription:
      'Runs OpenCode through ACP. Its adapter may be downloaded during the first connection test.',
    externalAgentNotTested: 'Not tested',
    externalAgentConnected: 'Connected',
    externalAgentFailed: 'Connection failed',
    externalAgentUnavailable: 'Unavailable',
    externalAgentTest: 'Test connection',
    externalAgentTestAll: 'Test all',
    externalAgentTesting: 'Testing…',
    externalAgentBackendMissing: 'The local ACP delegation runtime is missing.',
    externalAgentAdapterMissing: 'The ACP adapter for this agent is missing.',
    externalAgentAuthenticationRequired:
      'Sign-in is incomplete or credentials are invalid. Authenticate in the corresponding tool first.',
    externalAgentTimeout: 'The test timed out. Check the network and the tool’s sign-in state.',
    externalAgentConnectionFailed:
      'The ACP session could not be established. Review the diagnostics and confirm the tool is available.',
    externalAgentLastTested: 'Last tested:',
    externalAgentTestNotice:
      'Tests run only when clicked. Each opens and immediately closes an ACP session without a model request or tool use.',
    externalAgentPermissionNotice:
      'Real delegation follows the current session permission: Full Access can write files; Ask and Auto are read-only.',
    ...
    subagentEmpty: 'No delegated tasks in this session',
    subagentShowInfo: 'View details',
    subagentInfoStatus: 'Status',
    subagentInfoAgentRuntime: 'Execution runtime',
    subagentRuntimeNative: 'Built-in agent',
    subagentRuntimeAcp: 'External agent (ACP)',
    subagentRuntimeAcpShort: 'ACP',
    ...
    subagentDrawerTitle: 'Delegated task: {title}',
    subagentDrawerResize: 'Resize delegated task panel',
    subagentMessagesEmpty: 'No delegated task messages yet',
    subagentMessagesLoadFailed: 'Failed to load delegated task messages',
