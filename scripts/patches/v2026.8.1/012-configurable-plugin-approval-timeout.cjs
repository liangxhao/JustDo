...
// Target: openclaw@2026.8.1 plugin approval bounds and native approval callers.
...
const MARKERS = {
  default: 'JUSTDO_CONFIGURABLE_PLUGIN_APPROVAL_DEFAULT_V2026_8_1',
  max: 'JUSTDO_CONFIGURABLE_PLUGIN_APPROVAL_MAX_V2026_8_1',
  cliGateway: 'JUSTDO_CONFIGURABLE_CLI_PLUGIN_APPROVAL_GATEWAY_V2026_8_1',
  cliRegistration: 'JUSTDO_CONFIGURABLE_CLI_PLUGIN_APPROVAL_REGISTRATION_V2026_8_1',
  cliTimeout: 'JUSTDO_CONFIGURABLE_CLI_PLUGIN_APPROVAL_TIMEOUT_V2026_8_1',
  relayRegistration: 'JUSTDO_CONFIGURABLE_RELAY_PLUGIN_APPROVAL_REGISTRATION_V2026_8_1',
  relayTimeout: 'JUSTDO_CONFIGURABLE_RELAY_PLUGIN_APPROVAL_TIMEOUT_V2026_8_1',
  relayWait: 'JUSTDO_CONFIGURABLE_RELAY_PLUGIN_APPROVAL_WAIT_V2026_8_1',
  registration: 'JUSTDO_CONFIGURABLE_PLUGIN_APPROVAL_REGISTRATION_V2026_8_1',
  transport: 'JUSTDO_CONFIGURABLE_PLUGIN_APPROVAL_TRANSPORT_V2026_8_1',
};
