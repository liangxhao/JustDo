...
// Target: openclaw@2026.9.6 managed plugin catalog loading.
...
const MARKER = 'JUSTDO_OFFLINE_OFFICIAL_PLUGIN_CATALOG_V2026_9_6';
...
const PATCHED_CALL_PATTERN =
  /loadConfiguredHostedOfficialExternalPluginCatalogEntries(?:\$\d+|\d+)?\(\s*\{\s*offline\s*:\s*true\s*\}\s*\)(?:\/\*JUSTDO_OFFLINE_OFFICIAL_PLUGIN_CATALOG_V2026_9_6\*\/)?/gu;
