...
// Target: openclaw@2026.9.2 restart-safe chat admission for native Goal resume.
...
const MARKERS = {
  admission: 'JUSTDO_GOAL_RESUME_ABORTED_ADMISSION_V2026_9_2',
  guard: 'JUSTDO_GOAL_RESUME_ABORTED_GUARD_V2026_9_2',
};
