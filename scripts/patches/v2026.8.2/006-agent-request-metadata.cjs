...
// Target: pristine openclaw@2026.8.2, which does not publish these fields to provider payloads.
// Scope: chat.send admission plus the builtin_models/openai-completions provider boundary only.
// Safety: parent identity is read through v8.2's SQLite session accessor. Third-party providers
...
const CONTRACT = 'JUSTDO_AGENT_REQUEST_METADATA_V2026_8_2';
