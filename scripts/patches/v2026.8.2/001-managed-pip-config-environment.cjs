...
// Target: pristine openclaw@2026.8.2, whose host sanitizer blocks both environment variables.
...
const CAPTURE_MARKER = 'JUSTDO_V2026_8_2_MANAGED_PIP_CONFIG_CAPTURE';
const RESTORE_MARKER = 'JUSTDO_V2026_8_2_MANAGED_PIP_CONFIG_RESTORE';
