...
// Target: pristine openclaw@2026.8.2, which sends both as ordinary model completions.
...
const CONTRACT = 'JUSTDO_REQUEST_PURPOSE_METADATA_V2026_8_2';
...
const REVIEWER_SESSION_BLOCK = `// ${CONTRACT}: reviewer session lookup through v8.2 SQLite state.
