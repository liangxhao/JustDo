...
#
# Usage:
#   bash scripts/assets/mac-icon.sh regenerate                — regenerate macOS .icns from PNG icons
#   bash scripts/assets/mac-icon.sh fix-display <path-to-app> — fix macOS icon display on Apple Silicon
