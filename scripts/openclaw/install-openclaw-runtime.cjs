 ...
 *
 * Usage:
 *   node scripts/openclaw/install-openclaw-runtime.cjs <target-id>
 *
 * Example:
 *   node scripts/openclaw/install-openclaw-runtime.cjs win-x64
 */
...
if (!targetId) {
  fail('Missing target id. Usage: node scripts/openclaw/install-openclaw-runtime.cjs <target-id>');
}
