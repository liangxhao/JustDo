...
document.getElementById('pairingProductName').textContent = productName;

const STATE_LABEL = {
  on: `Connected to ${productName}`,
  connecting: 'Connecting…',
  error: `Relay unreachable — is ${productName} running?`,
  off: 'Not connected',
};
...
async function refresh() {
  ...
  shareButton.textContent = shared ? 'Stop sharing this tab' : `Share this tab with ${productName}`;
