...
| `016-litellm-session-id.cjs`                     | Forward session, direct-parent session, request-purpose, and explicit human-user initiation metadata on agent, safeguard-compaction, and exec-review OpenAI-compatible model requests                                          |
