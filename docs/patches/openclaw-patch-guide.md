...
| `016-litellm-session-id.cjs`                     | Forward session, direct-parent session, and request-purpose metadata on agent, safeguard-compaction, and exec-review OpenAI-compatible model requests                                                                          |
...
| `016-litellm-session-id.cjs`                     | Missing provider request correlation and purpose metadata | Remove when OpenClaw forwards its session UUID, direct-parent UUID, and request purpose for agent, compaction, and exec-review requests                           |
